...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(isearch ((,class (:foreground ,background-red :background ,red ))))
   `(lazy-highlight ((,class (:foreground ,red :weight bold :background ,background-red :underline t))))
   ...
   `(outline-4 ((,class (:foreground ,orange :weight bold))))
   `(outline-5 ((,class (:foreground ,blue :weight bold))))
   `(outline-6 ((,class (:foreground ,purple :weight bold))))
   `(outline-7 ((,class (:foreground ,green :weight bold))))
   ...
   ;; `(org-block-end-line ((,class (:background ,background-green :foreground ,green-light :height 0.9))))
     `(org-block ((,class (:background ,background-darker ))))
